...
const TechRow = ({
  ...
  <div className="group relative overflow-hidden rounded-xl border border-purple-500/15 bg-gradient-to-br from-purple-500/[0.06] to-transparent hover:border-purple-500/25 transition-all duration-300">
    <div className="p-6 flex items-start space-x-6">
      <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center border border-purple-500/20 bg-gradient-to-br from-purple-500/15 to-purple-800/10 text-purple-300 group-hover:scale-110 transition-transform">
      ...
      <div className="flex-grow">
        ...
        <div className="relative">
          ...
          >
            <p className="text-gray-400 font-mono text-sm leading-relaxed text-purple-300/90">
